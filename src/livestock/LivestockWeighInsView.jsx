        ...
        {!loadFailed &&
          ...
          (() => {
            ...
            if (species === 'pig') {
              ...
              const hasMetrics = (s) =>
                (entries[s.id] || []).length > 0 && metric(s) && metric(s).available;
              columns.push(
                {
                  key: 'age',
                ...
                },
                {
                  ...
                  mobilePriority: false,
                  render: (s) =>
                    hasMetrics(s) ? formatFeedPerPig(metric(s).feed_per_pig_lbs) : <StatusText tone="muted">{'—'}</StatusText>,
                },
                {
                  key: 'groupAdg',
                  label: 'Group ADG',
                ...
                },
                {
                  ...
                  align: 'right',
                  render: (s) =>
                    hasMetrics(s) ? formatAvgWeight(metric(s).avg_weight_lbs) : <StatusText tone="muted">{'—'}</StatusText>,
                },
                {
                  key: 'entryAdg',
