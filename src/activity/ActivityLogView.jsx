...
const ENTITY_FILTERS = [
  ...
  {value: 'cattle.breeding', label: 'Cattle Breeding'},
  {value: 'sheep.animal', label: 'Sheep'},
  {value: 'sheep.processing', label: 'Sheep Processing'},
  {value: 'equipment.item', label: 'Equipment'},
  {value: 'equipment.fuel_bill', label: 'Fuel Bill'},
  {value: 'processing.record', label: 'Processing'},
