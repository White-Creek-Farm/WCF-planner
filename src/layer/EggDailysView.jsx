            ...
            columns={[
              {key: 'date', label: 'Date', render: (d) => fmt(d.date)},
              {
                ...
                render: (d) => {
                  ...
                  return <span style={{fontWeight: 700, color: '#78350f', whiteSpace: 'nowrap'}}>{'🥚 ' + total + ' eggs'}</span>;
                },
              },
              {
                key: 'team',
              ...
              },
              {
                ...
                render: (d) =>
                  parseFloat(d.dozens_on_hand) > 0 ? (
                    <span style={{color: '#065f46', fontWeight: 600, whiteSpace: 'nowrap'}}>{'📦 ' + d.dozens_on_hand}</span>
                  ) : (
