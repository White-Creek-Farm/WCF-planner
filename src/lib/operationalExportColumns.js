...
export function buildPigBatchExportColumns({fmt} = {}) {
  return [
    ...
    {header: 'Started pigs', value: (r) => number(r.started_count)},
    {header: 'Current pigs', value: (r) => number(r.current_count)},
    {header: 'Trip pigs', value: (r) => number(r.trip_pigs)},
    {header: 'Transfer pigs', value: (r) => number(r.transfer_pigs)},
    {header: 'Mortality', value: (r) => number(r.mortality_count)},
    {header: 'Total live lbs', value: (r) => rounded(r.total_live_lbs, 1)},
    {header: 'Adjusted feed lbs', value: (r) => rounded(r.adjusted_feed_lbs, 1)},
    {header: 'FCR', value: (r) => rounded(r.fcr, 3)},
