...
export default function TaskInstancePage({sb, authState, Header}) {
  ...
  return (
    <div style={{minHeight: '100vh', background: '#f9fafb'}}>
      {Header && <Header />}
      <div style={{maxWidth: 760, margin: '0 auto', padding: '16px 18px'}}>
        ...
        {!loading && !record && (
          <div style={{background: 'white', border: '1px solid #e5e7eb', borderRadius: 12, padding: '2rem'}}>
            ...
            <div style={{color: '#6b7280', fontSize: 13}}>Task not found.</div>
          </div>
        )}
          ...
          <div style={{display: 'flex', flexDirection: 'column', gap: 16}}>
            ...
            <div style={{background: 'white', border: '1px solid #e5e7eb', borderRadius: 12, padding: '14px 20px'}}>
              <div style={{display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap', marginBottom: 10}}>
                <h1 data-record-title="1" style={{fontSize: 20, fontWeight: 700, color: '#111827', margin: 0}}>
                  {record.title}
                </h1>
              ...
              <div style={{display: 'flex', flexDirection: 'column'}}>
                ...
                {(() => {
                  ...
                  return (
                    <div style={fieldRow}>
                      <span style={fieldLabel}>{attr.label}</span>
                      <span>{attr.name}</span>
                    </div>
                  );
                })()}
