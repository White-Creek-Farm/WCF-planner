      ...
      <div style={{padding: '1rem', maxWidth: 1200, margin: '0 auto'}}>
        ...
        {!loading && !loadError && filtered.length > 0 && (
          <DataTable
            ...
            rowStyle={(d) => {
              const notable =
                parseInt(d.mortality_count) > 0 || (d.issues && String(d.issues).trim().length > 2);
            ...
            columns={[
                ...
                render: (d) => {
                  ...
                  return (
                    <span style={{display: 'inline-flex', flexDirection: 'column', gap: 2}}>
                      ...
                      {mineralSummary && (
                        <span style={{fontSize: 11, color: '#6b21a8'}}>{'🧂 ' + mineralSummary}</span>
                      )}
                    </span>
                  );
                },
              },
              {
                ...
                render: (d) => {
                  ...
                  const text =
                    '💀 ' + d.mortality_count + (d.mortality_reason ? ' — ' + d.mortality_reason : '');
                  return (
